<?php 
  ...
  if(isset($_SESSION['id_user'])) {
    header("Location: ../campus/company/dashboard.php");
    exit();
  }
    ...
    <div class="row border rounded-5 p-3 bg-white shadow box-area">
      ...
      <div class="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box" style="background: #282A3A;">
        <div class="featured-image mb-3">
          <img src="img/2.jpg" class="img-fluid" style="width: 250px;">
        </div>
        <p class="text-white fs-2" style="font-family: 'Courier New', Courier, monospace; font-weight: 600;">Join Us </p>
        <small class="text-white text-wrap text-center" style="width: 17rem;font-family: 'Courier New', Courier, monospace;">Find out new talents</small>
      </div>
        ...
        <div class="row align-items-center">
          ...
          <form method="post" action="checkcompanylogin.php">
            <div class="input-group mb-3">
              <input class="form-control form-control-lg bg-light fs-6" type="email" id="email" name="email" placeholder="Email" required="">
            </div>
            ...
            <div class="input-group mb-5 d-flex justify-content-between">
              ...
              <div class="forgot">
                <small><a href="companyforgot-password.php">Forgot Password?</a></small>
              </div>
            </div>
            <div class="input-group mb-3">
            ...
            <div class="row">
              <small>Don't have account? <a href="company-registerr.php">Register</a></small>
            </div>
            <?php
